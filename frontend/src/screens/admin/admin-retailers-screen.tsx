...
export function AdminRetailersScreen({ navigation }: { navigation: any }) {
  ...
  return (
    <SafeAreaView className="flex-1 max-w-3xl mx-auto w-full bg-background" edges={["top", "bottom"]}>
      ...
      <View className="h-16 px-4 flex-row items-center justify-between bg-surface/80">
        ...
        >
          <MaterialIcons name="person-add" size={24} className="text-on-surface" />
        </Pressable>
      </View>
 ...
 />
        ...
        <View className="flex-row items-center justify-between">
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="Button" className="p-2 ml-2 bg-surface-container-high rounded-full flex-shrink-0">
          ...
          isLoading ? (
            ...
            <View className="flex-col items-center justify-center p-8 mt-8">
              <View className="w-32 h-32 bg-surface-container-high rounded-full flex items-center justify-center mb-4">
                <MaterialIcons name="storefront" size={48} className="text-on-surface-variant" />
              </View>
            ...
            >
              <View className="flex-row justify-between items-start">
                ...
                <View className="flex-row items-center gap-2">
                  ...
                  <MaterialIcons name="more-vert" size={20} className="text-on-surface" />
                </View>
              </View>
        ...
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-surface rounded-t-3xl p-6 h-[80%]">
            <View className="flex-row justify-between items-center mb-4">
              ...
              <Pressable accessibilityRole="button" accessibilityLabel="Button" onPress={() => setSelected(null)}>
                <MaterialIcons name="close" size={24} className="text-on-surface" />
              </Pressable>
            </View>
            
            {msg && <Text className="text-error mb-2 font-semibold">{msg}</Text>}
