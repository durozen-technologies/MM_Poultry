...
export function AdminDeliveryRunsScreen({ navigation }: { navigation: any }) {
 ...
 <Pressable
 className="bg-white rounded-lg p-4 mb-3 border border-[#e5e7eb] flex-row items-center justify-between"
 onPress={() =>
 ...
 <Text className="text-lg text-[#5f6368] text-[#202124]">{item.route_name}</Text>
 ...
 <Text className="text-xs text-[#2E7D32] mt-1">
 Unassigned:{""}
 ...
 ListHeaderComponent={
 <View className="bg-[#f7f8fa]-low rounded-lg p-4 mb-3 border border-[#e5e7eb]">
 <Text className="text-sm font-bold text-[#5f6368] font-semibold text-[#202124] mb-2">Available stock</Text>
 <DispatchItemSummaryList
 items={data?.available_items ?? []}
 emptyLabel="No stock on hand"
 className="gap-1 mb-3"
 />
 <Text className="text-sm font-bold text-[#5f6368] font-semibold text-[#202124] mb-2">Total confirmed</Text>
 <DispatchItemSummaryList
 items={data?.confirmed_items ?? []}
 emptyLabel="No confirmed orders"
 className="gap-1 mb-3"
 />
 <Text className="text-sm font-bold text-[#5f6368] font-semibold text-[#202124] mb-2">Unassigned</Text>
 <DispatchItemSummaryList
 ...
 ListEmptyComponent={
 <Text className="text-center text-[#5f6368] py-8">No routes configured</Text>
 }
